...
namespace CharacterGenerator.Controllers
{
    ...
    //Wizard
        ...
        {
            Console.WriteLine("Full list section ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
            Console.WriteLine("fullListAvail");
            ...
            for(int i=1; i<=PC.Level; i++) // I was thinking of while loops lol
            {
                    ...
                    switch(Spell_Level_Available)
                        {
                            case 1:
                                //Add level1 association, twice to represent spells gained on level up
                                availableSpells.Add(levelOne[1]);
                                Console.WriteLine(levelOne[1]);
                                availableSpells.Add(levelOne[1]);
                                break;
                            case 2:
                ...
                //Final Check
                Console.WriteLine("Checking list of available spells, post generation ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                foreach(Spell spell in availableSpells)
                {
                    Console.WriteLine($"{spell.SpellName} LVL: {spell.SpellLevel}");
                }
            }
